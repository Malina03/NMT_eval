...
checkpoint="${root_dir}/models/${model}/ft2/${corpus}/checkpoint-*?"

for eval_corpus in ${corpora[@]}; do
    log_file="/scratch/hb-macocu/NMT_eval/en-sq/logs/eval/${corpus}/eval_${eval_corpus}.log"
